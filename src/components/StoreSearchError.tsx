...
export default function StoreSearchError() {
  ...
  return (
    <div className="flex h-screen w-screen flex-col items-center justify-center gap-4">
      <div className="prose rounded-md bg-white p-6 md:p-12">
        <h2>Sorry, an error occured searching your stores</h2>
        <h3>Why does this occur?</h3>
        <p>
          Currently, there are limitations on which stores can be searched.
          Please check that the store(s) searched matches the following
          criteria:
        </p>
